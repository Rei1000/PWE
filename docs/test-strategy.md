...
- **Qualification Engine** (Gate 8.1b 🔄): Domain Startregel / Profil / Einweisung; Application Profil- und Einweisungs-Verwaltung + Publish-Übernahme; API `/identity/*`, Start-403 `qualifikation_unzureichend`, Ownership an Prüflauf-Mutationen; Alembic `0004`; Tests `test_qualification_application.py`, `test_qualification_api.py`, Support `tests/support/qualification.py`. Stand Feature-Branch: Backend non-PG **~410**, PostgreSQL **42**, Frontend **113**.
